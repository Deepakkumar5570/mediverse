  ...
  return (
    <LearnLayout>
      <main className="space-y-8">
        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-amber-100 bg-gradient-to-br from-amber-50 via-white to-orange-50 p-6 shadow-sm sm:p-10">
          ...
          <div className="relative max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base">
              Know what you want to practice? Select your
              program, search for a topic or subtopic, and
              jump straight into MCQs.
            </p>
          </div>
        </section>
        ...
        {programs.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-slate-300 bg-white px-6 py-14 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Practice will appear here once curriculum
